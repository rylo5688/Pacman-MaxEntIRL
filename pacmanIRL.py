...
###################################################
# FUNCTIONS FOR Inverse Reinforcmenet Learning    #

# def computeProbabilityMass()

# # https://www.aaai.org/Papers/AAAI/2008/AAAI08-227.pdf
# def expectedEdgeFrequency(demo, iterations=100):
#     # Step 1: Should this be a list?
#     z = 0
...
def readCommand(argv):
    ...
    pacman = pacmanType([ .603471071, -809.362921, 16.5522190])  # Instantiate Pacman with agentArgs
...
def runGames(layout, pacman, ghosts, display, numGames, record, numTraining=0, catchExceptions=False, timeout=30):
    ...
    for i in range(numGames):
        ...
        if record:
            ...
            # TODO: Write out the state/action vector to a file
            components = game.demo
